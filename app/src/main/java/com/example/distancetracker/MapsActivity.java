...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback  {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // Add a marker to the current Position and move the camera

        /*
        Bundle extras = getIntent().getExtras();
        if (extras != null) {
            LatLng currentLocation = new LatLng(Double.parseDouble(extras.getString("LAT")), Double.parseDouble(extras.getString("LON")));
